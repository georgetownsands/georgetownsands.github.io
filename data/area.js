export default [
        ...
        detail: [
          {
            ...
            address: "1174 Duck Rd Downstairs, Duck, NC 27949",
            description: "Waterfront dining in Duck.",
          ...
          },
          {
            ...
            address: "1240 Duck Road Duck, NC 27949",
            description:
              "Mellow  for locally sourced, high-end seafood & Southern fare, with occasional live music.",
          ...
          },
          {
            ...
            description:
              "Great Sound Front Tex Mex Restaurant, serving Ice Cold Draft Beer ,Fish Tacos, Quesadillas and Duck or Crab Mexican Pizza",
          ...
          },
          {
            ...
            name: "Cravings",
            description:
              "Casual Dining, Nightlife, Serving Breakfast, Lunch and Dinner",
            address: "1209 Duck Road Duck, NC 27949",
          ...
          },
          {
            ...
            name: "Duck Deli",
            description:
              "Duck Deli is a small family style restaurant featuring BBQ and much, much more.",
          ...
          },
          {
            id: 507,
            name: "Duck Pizza",
            description: "The best craft pizza on the northern Outer Banks",
            address: "1171 Duck Rd, Scarborough Lane Shoppes, Duck, NC",
          ...
          },
          {
            ...
            description: "sip savor sunset",
            webSite: "https://www.eventideduck.com/",
          },
          {
            id: 509,
            name: "Fishbones Raw Bar & Restaurant",
            description:
              "Creative Caribbean style Cuisine combined with fresh local Outer Banks Seafood to complement its upbeat casual dining atmosphere",
            address: "1171 Duck Rd, Duck, NC 27949",
            phoneNumber: "252.261.6991",
            webSite: "https://www.fishbonesrawbar.com/Home",
          },
          {
            id: 510,
            name: "NC Coast Grill & Bar",
            description: "A Chef-Driven Outer Banks Restaurant Experience",
          ...
          },
          {
            id: 511,
            name: "Pizazz Pizza",
            description: "Outer Banks Pizza At Its Best",
            address: "1187 Duck Rd, Duck, NC 27949",
            phoneNumber: "252.252.111",
          ...
          },
          {
            ...
            name: "Red Sky Cafe",
            description:
              "For more than 15 years, Red Sky Cafe restaurant in Duck, NC, has been delighting locals and visitors with fresh, creative meals that highlight local Outer Banks seafood, poultry, beef, duck and more. ",
          ...
          {
            id: 520,
            name: "Roadside Bar & Grill",
            description:
              "Seafood-centric American dining in a quaint renovated house with an upstairs bar & grill.",
          ...
          },
          {
            ...
            description:
              "Pure coffee love.  Located in Scarborough Faire Shopping Village.",
    ...
    data: [
      {
        ...
        detail: [
          ...
          {
            id: 603,
            name: "Dockside N' Duck",
            phoneNumber: "252.261.8687",
            address: "1216 Duck Rd, Duck, NC 27949",
            description:
              "Excellent fresh seafood market serving Duck since 1987.",
          ...
          },
          {
            id: 605,
            name: "Duck Donuts",
            description: "warm, delicious, made to order",
            phoneNumber: "252.262.1406",
            address: "1190 Duck Road Duck, NC 27949",
          ...
          },
          {
            ...
            description: "",
            address: "1216 Duck Rd, Duck, NC 27949",
            searchWords: "fruit vegetable nuts pickles",
          ...
          },
          {
            ...
            address: "1242 Duck Rd, Duck, NC 27949",
            description: "Natural foods and wine shop",
            webSite: "https://tommysmarketobx.com/",
          },
          {
            id: 611,
            name: "Sweet Ts",
            description:
              "A place to gather.  Local coffee. Craft beer. Curated Wine.",
          ...
          },
          {
            ...
            description: "Featuring Freshly Baked Goods Everyday!",
            phoneNumber: "252.261.7112",
            address: "1187 Duck Road Duck, NC 27949",
            webSite: "https://www.tulliosbakery.com/",
          },
          {
            id: 621,
            name: "Wee Winks Market",
            phoneNumber: "252.261.2937",
            address: "1213 Duck Rd, Duck, NC 27949",
            description: "Market and Deli",
      ...
      {
        id: 61,
        name: "Hardware and home goods",
        detail: [
          {
            id: 631,
            name: "Kellog Supply Company",
            description: "Hardware and much more.",
  ...
  },
  {
    ...
    data: [
      {
        id: 71,
        name: "Featured Rental Units",
        detail: [
          {
            id: 701,
            name: "Favorite Song - Unit 31",
            description:
              "Newly decorated, bright end unit.  $250 rental credit for in-season, full-week rentals.",
            webSite:
              "https://shorelineobx.com/vacation_rentals/gsnd-31-favorite-song-sat-sat/",
          },
        ],
      },
      {
        ...
        detail: [
          {
            ...
            name: "Brindley Beach",
            description:
              "The Brindley Beach Difference: Service First... Fun Always",
            webSite: "https://www.brindleybeach.com/georgetown-sands",
          },
          {
            id: 703,
            name: "Resort Realty",
            description: "Find Your Outer Banks Vacation Rental By The Sea",
            webSite:
              "https://www.resortrealty.com/outer-banks/duck/georgetown-sands-condos/?neighborhood_area_id=11447&home_type_id=4616",
          },
          {
            id: 704,
            name: "Sun Realty",
            description: "The Best in Outer Banks Vaction Rentals",
  ...
  },
  {
    ...
    data: [
        ...
        detail: [
          {
            ...
            name: "Duck Cycle",
            description:
              "Bike, beach, and watersports rentals - delivery to Corolla, Pine Island, Duck, Southern Shores, Kitty Hawk",
          ...
          {
            id: 810,
            name: "Duck Village Outfitters",
            description: "Bikes, surfboards, kayaks, beach equipment, and more",
      ...
      {
        id: 83,
        name: "Wild Horse Tours",
        detail: [
          {
            id: 831,
            name: "Corolla Wild Horse Tours",
            description: "Wild horse tours",
          ...
          },
          {
            ...
            description:
              "See the NC state horse: the OBX Wild Spanish Mustang Horses",
        ...
        detail: [
          {
            ...
            description:
              "Stunning sunsets, natual beauty, soundside activities, amazing music, and family fun.",
        ...
        detail: [
          {
            ...
            description:
              "Hang gliding, parasailing, jet ski rentals, boat tours, and more",
            address: "1226 Duck Rd, Duck, NC 27949",
            phoneNumber: "252.261.4450",
            webSite:
              "https://www.kittyhawk.com/location/duck-kitty-hawk-kites/",
          },
        ],
      },
      {
        ...
        detail: [
          {
            ...
            name: "Village Yoga",
            description:
              "Village Yoga is a social entrepreneurship on the Outer Banks that specializes in making yoga available to all levels.",
